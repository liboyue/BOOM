from src.bioasq_modules.BiRanker import BiRanker
from src.bioasq_modules.SimilarityJaccard import *
	...
	def getRankedList(self, question, alpha, beta):
		...
		for i in range(self.numSelectedSentences):
			...
			for sentence in sentences:
				...
				similarityInstance = SimilarityJaccard(sentence, question['query'])
